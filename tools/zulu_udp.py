...
Vendored from AkaiS1000/tools/zulu_udp.py: the protocol is machine-agnostic
(byte ranges of an image id), so the same client drives the S950 image.
Keep the two copies in step if the firmware protocol changes.
"""
